    ...
    public CommandLineRunner demo(CampaignRepository cRepository,
        ...
        return (args) -> {
            if (!uRepository.existsByUsername("admin")) {
                ...
                AppUser testUser1 = new AppUser("user1", "$2a$10$QkkwsO61MqIVTMdf60.AReRHTDCs7pPNz/kOTZMOwfsqh4AjAy2dm",
                        testTimeNow, "USER");
                AppUser testUser2 = new AppUser("user2", "$2a$10$/iZiuKOq5H4/ZpANveL9KezgXuGo8DqiAzOzzgi.8//bda28gQVgu",
                        testTimeNow, "USER");
                uRepository.save(testUser1);
                uRepository.save(testUser2);

                AppUser testAdmin = new AppUser("admin", "$2a$10$qKjgF7ibr/9.hAULqzabm.nd.rY/zPLANE1eCf3XUVHQQCSsNDxEm",
                        testTimeNow, "ADMIN");
                ...
                GameSession testSession1 = new GameSession(testCampaign, "Testiseikkailu eka",
                        "Tässä seikkailussa tapahtui",
                ...
                GameSession testSession2 = new GameSession(testCampaign, "Testiseikkailu toka",
                        "Tässä seikkailussa tapahtui",
                        testTimeNow, testTimeNow);
