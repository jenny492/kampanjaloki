...
import com.github.jenny492.kampanjaloki.Storage.StorageFileNotFoundException;
...
public class FileUploadController {
	...
	public String listUploadedFiles(@RequestParam("campaignid") Long campaignid, Model model) throws IOException {
    ...
    public String handleFileUpload(@RequestParam("file") MultipartFile file,
        ...
        storageService.store(file);
                ...
                Campaign campaign = cRepository.findById(campaignid).orElseThrow();
                campaign.setImageUrl(file.getOriginalFilename());
